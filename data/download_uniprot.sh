...
#
# Downloads and unzips the SwissProt database for AlphaFold-Multimer.
#
# Usage: bash download_swissprot.sh /path/to/download/directory
set -e
...
echo "SwissProt database has been downloaded and extracted to ${ROOT_DIR}."
